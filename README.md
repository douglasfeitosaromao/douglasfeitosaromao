...
Ph.D. and M.A. in Communication (UFF, with a doctoral research stay at Paris 1 Panthéon-Sorbonne / BnF) · B.A. in Philosophy (USP). My working thesis: editing a database's parameters is editing how we see — so I spend my days philosophizing about JOINs and OCR pipelines in more or less equal measure.
...
| **[endpoints-clio-tainacan](https://github.com/douglasfeitosaromao/endpoints-clio-tainacan)** | REST API for digital collections, self-initiated during FAPESP Technical Training Fellowship 24/16083-7 — Tainacan integration, AI-based document processing (OCR/NER), Google Drive sync |
